package io.github.stanreshetnyk.titanic
...
/**
 * Copy from https://github.com/BenFradet/spark-kaggle/blob/master/titanic/src/main/scala/io/github/benfradet/Titanic.scala
 * Original score was 0.79426
 *
 */
object TitanicSpark extends App {

  val csvFormat = "com.databricks.spark.csv"

  val STORAGE = "data/titanic/"
  ...
  val (dataDFRaw, predictDFRaw) = loadData(TRAIN_FILE, TEST_FILE, sqlContext)
  ...
  FileUtils.deleteDirectory(new File(RESULT_FILE))
  ...
  def loadData(
    trainFile: String,
    testFile: String,
    sqlContext: SQLContext): (DataFrame, DataFrame) = {
    val nullable = true
